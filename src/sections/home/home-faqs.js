      ...
      <Grid container spacing={3}>
        <Grid xs={12} md={4}>
          <Stack spacing={3}>
            <HomeFaqCard question="Do you have a free demo to review the code before purchasing?">
              ...
              <br />
              <br />
              Keep in mind that some aspects may differ from the Better Path - Admin Dashboard Paid
              version.
            </HomeFaqCard>
            <HomeFaqCard question="How many projects can I build with Better Path - Admin Dashboard?">
        ...
        <Grid xs={12} md={4}>
          <Stack spacing={3}>
            ...
            <HomeFaqCard question="What browsers does Better Path - Admin Dashboard support?">
        ...
        <Grid xs={12} md={4}>
          <Stack spacing={3}>
            ...
            <HomeFaqCard question="Does Better Path - Admin Dashboard include Figma, Sketch, or Adobe XD files?">
              ...
              <Link
                href="https://www.figma.com/file/4XoBSB4Sl2fSpD9OebSsr3/Better Path---Admin-Dashboard-v2.0?node-id=7435%3A43141"
                rel="nofollow noreferrer noopener"
                target="_blank"
                underline="none"
                variant="inherit"
